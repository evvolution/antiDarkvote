    ...
    $.ajax({
        ...
        success:function(data){
            ...
            for(var i=0;i<data.projects[0].length;i++){
                ...
                var modaltmp = '';
                var modal1 = '<div class="modal fade" id="modalforvideo' + i + '" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog" role="document">';
                ...
                var modal5 = '<video class="fsvideo" controls="controls" poster="' + data.projects[0][i].pic_url + '" preload="none" src="' + data.projects[0][i].url + '"></video>';
                var modal6 = '<div class="modaldetail">' + data.projects[0][i].content.split("作品简介:")[1] + '</div>';
                var modal7 = '<button class="vote" onclick>投票</button></div></div></div></div>';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            for(var i=0;i<data.projects[0].length;i++){
                ...
                var modaltmp = '';
                var modal1 = '<div class="modal fade" id="modalformovie' + i + '" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog" role="document">';
                var modal2 = '<div class="modalmain modal-content"><div class="modaltitlepic"><img src="img/modaltitle.png"></div>';
                var modal3 = '<div class="modalcontent"><p class="modaldetailintro">标题：<span>' + data.projects[0][i].title + '</span></p><br/>';
                var modal4 = '<p class="modaldetailintro">报送单位：<span>' + data.projects[0][i].content.split("报送单位:")[1].split("作品简介:")[0] + '</span></p>';
                var modal5 = '<video class="fsvideo" controls="controls" poster="' + data.projects[0][i].pic_url + '" preload="none" src="' + data.projects[0][i].url + '"></video>';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            for(var i=0;i<data.projects[0].length;i++){
                ...
                var modaltmp = '';
                var modal1 = '<div class="modal fade" id="modalforcartoon' + i + '" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog" role="document">';
                var modal2 = '<div class="modalmain modal-content"><div class="modaltitlepic"><img src="img/modaltitle.png"></div>';
                var modal3 = '<div class="modalcontent"><p class="modaldetailintro">标题：<span>' + data.projects[0][i].title + '</span></p><br/>';
                var modal4 = '<p class="modaldetailintro">报送单位：<span>' + data.projects[0][i].content.split("报送单位:")[1].split("作品简介:")[0] + '</span></p>';
                var modal5 = '<video class="fsvideo" controls="controls" poster="' + data.projects[0][i].pic_url + '" preload="none" src="' + data.projects[0][i].url + '"></video>';
